class BinartSearchTreeMap:
    ...
    def get_ith_smallest(self, i):
        ...
        def subtree_ith_smallest(node, i):
            if node.left is not None:
                start_index = node.left.size
            else:
                start_index = 0
            ...
            if i == start_index + 1:
                ...
                return subtree_ith_smallest(node.left, i)

            else:
                return subtree_ith_smallest(node.right, i - start_index - 1)
        return subtree_ith_smallest(self.root, i)
